          ...
          ?>
            <div class="center">
              <div class="myAlert-top alert alert-success">
                ...
                <strong>Successfully!</strong> Payment is added. 
              </div>
            </div>
          <?php
        ...
        elseif (!empty($_SESSION['success-edit'])) {
          ?>
            <div class="center">
              <div class="myAlert-top alert alert-success">
                <a href="#" class="close" data-dismiss="alert" aria-label="close"> &times;</a>
                <strong>Successfully!</strong> Payment is updated. 
              </div>
            </div>
          <?php
        ...
        elseif (!empty($_SESSION['success-del'])) {
          ?>
            <div class="center">
              <div class="myAlert-top alert alert-success">
                <a href="#" class="close" data-dismiss="alert" aria-label="close"> &times;</a>
                <strong>Successfully!</strong> Payment is deleted. 
              </div>
            </div>
          <?php
                ...
                <div class="card">
                            <div class="card-header">
                                <strong class="card-title">
                                  <a href="payment-insert.php?country_id=<?php echo $country_id ?>"><i class="fa fa-plus cat-circle-icon-purple text-light p-2 font-2xl"></i></a>
                                  &nbsp;Add Payment Method
                                </strong>
                            </div>
                            <div class="card-body">
...
<?php
  ...
  $sel_qur_cat   = "SELECT payment_type.id ,payment_method.name , payment_method.enable  FROM PaymentType as payment_type
  INNER JOIN PaymentMethod as payment_method ON payment_method.id = payment_type.payment_method_id
  WHERE payment_type.country_id = '".$country_id."' AND payment_type.enable = '0'
...
?>
                ...
                <tr>
                    ...
                    <td>
                      <a href="payment-edit.php?id=<?php echo $id ?>&country_id=<?php echo $country_id ?>"><i class="fa fa-pencil cat-circle-icon-black text-light p-2 font-2xl"></i></a>
                      <a href="payment-actions.php?id=<?php echo $id ?>&country_id=<?php echo $country_id ?>"><i class="fa fa-times cat-circle-icon-red text-light p-2 font-2xl"></i></a>
                    </td>
                    </td>
                    <td>
                ...
                function show1(str, str1) {
                  ...
                  xhttp.open("GET", "updateUserToggle.php?var1=" + str + "&& var2="+str1+ "&& type=payment", true);
                  xhttp.send();
                }
                </script>
                <div id="testing1"></div>
