          ...
          ?>
            <div class="center">
              <div class="myAlert-top alert alert-success">
                ...
                <strong>Successfully!</strong> City is added. 
              </div>
            </div>
          <?php
        ...
        elseif (!empty($_SESSION['success-edit'])) {
          ?>
            <div class="center">
              <div class="myAlert-top alert alert-success">
                <a href="#" class="close" data-dismiss="alert" aria-label="close"> &times;</a>
                <strong>Successfully!</strong> City is updated. 
              </div>
            </div>
          <?php
        ...
        elseif (!empty($_SESSION['success-del'])) {
          ?>
            <div class="center">
              <div class="myAlert-top alert alert-success">
                <a href="#" class="close" data-dismiss="alert" aria-label="close"> &times;</a>
                <strong>Successfully!</strong> City is deleted. 
              </div>
            </div>
          <?php
                ...
                <div class="card">
                            <div class="card-header">
                                <strong class="card-title">
                                  <a href="city-insert.php?country_id=<?php echo $country_id ?>"><i class="fa fa-plus cat-circle-icon-purple text-light p-2 font-2xl"></i></a>
                                  &nbsp;Add City
                                </strong>
                            </div>
                            <div class="card-body">
...
<?php
  ...
  $sel_qur_cat   = "SELECT * FROM Location WHERE country_id = '".$country_id."' order by id DESC";
...
?>
                ...
                <tr>
                    ...
                    <td>
                      <a href="city-edit.php?id=<?php echo $id ?>&country_id=<?php echo $country_id ?>"><i class="fa fa-pencil cat-circle-icon-black text-light p-2 font-2xl"></i></a>
                      <a href="city-actions.php?id=<?php echo $id ?>&country_id=<?php echo $country_id ?>"><i class="fa fa-times cat-circle-icon-red text-light p-2 font-2xl"></i></a>
                    </td>
                    </td>
                    <td>
                ...
                function show1(str, str1) {
                  ...
                  xhttp.open("GET", "updateUserToggle.php?var1=" + str + "&& var2="+str1+ "&& type=city", true);
                  xhttp.send();
                }
                </script>
                <div id="testing1"></div>
