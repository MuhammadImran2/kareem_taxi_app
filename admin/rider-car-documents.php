...
<?php
  ...
  WHERE captain_doc.term_id = '".$rider_id."' AND captain_doc.document_type = 'car_documents' ";
                  ...
                  <td>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="rider-detail-actions.php?id=<?php echo $id ?>&action=approved&rider_id=<?php echo $rider_id ?>&type=rider-car-documents" class="dropdown-item">Approved</a>
                                <a href="rider-detail-actions.php?id=<?php echo $id ?>&action=declined&rider_id=<?php echo $rider_id ?>&type=rider-car-documents" class="dropdown-item">Declined</a>
